...
public class ModBlocks {
    public static final Block BLOCK_OF_BAMBOO = registerBlock("block_of_bamboo",
            new PillarBlock(FabricBlockSettings.of(Material.BAMBOO_SAPLING)), ItemGroup.BUILDING_BLOCKS);
    ...
    public static final Block BAMBOO_FENCE_GATE = registerBlock("bamboo_fence_gate",
            new FenceGateBlock(FabricBlockSettings.of(Material.BAMBOO_SAPLING)), ItemGroup.BUILDING_BLOCKS);
